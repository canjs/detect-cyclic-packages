# Contributing to detect-cyclic-packages
...
This section will walk you through setting up the [repository](https://github.com/canjs/detect-cyclic-packages) on your computer.
...
```shell
git clone https://github.com/YOUR-USERNAME/detect-cyclic-packages
```
